<template>
  <div id="sell">
    ...
    <div class="layout">
      <div style="padding-right: 40px" class="layout__item med-force--40">
    ...
    <!-- The bottom bar will be a component -->
    <button class="o-btn">Back</button>
    <button class="o-btn">Next</button>
